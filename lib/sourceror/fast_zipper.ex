defmodule Sourceror.FastZipper do
  ...
  ## Examples
      ...
      false
      iex> follow_path(if_zipper, first_path) |> Sourceror.FastZipper.node() |> Sourceror.to_string()
      "target()"
      iex> follow_path(if_zipper, second_path) |> Sourceror.FastZipper.node() |> Sourceror.to_string()
      "target()"
  ...
  ## Examples
      ...
      iex> rewritten
      ...> |> follow_path(path)
      ...> |> then(fn zipper -> replace(zipper, {:wrapped, [], [Sourceror.FastZipper.node(zipper)]}) end)
      ...> |> topmost_root()
      ...> |> Sourceror.to_string()
      "if active?(flag) do\\n  target()\\n  wrapped(target())\\nend"
